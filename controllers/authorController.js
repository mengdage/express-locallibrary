...
exports.author_create_post = function(req, res, next) {
  ...
  var author = new Author({
    ...
    date_death: req.body.date_of_death
  });

  if(errors) {
    res.render('author_form', {title: 'Create Authro', author: author, errors: errors});
  } else {
    // Chekc if exists
...
exports.author_delete_get = function(req, res, next) {
  async.parallel({
    ...
    res.render('author_delete', {title: 'Delete Authro', author: results.author, author_books: results.authors_books});
  })
};
